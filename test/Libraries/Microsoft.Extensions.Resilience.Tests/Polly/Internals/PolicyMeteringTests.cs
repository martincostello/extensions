...
public class PolicyMeteringTests : IDisposable
{
    ...
    public void Initialize_EnsurePipelineKeyRespected(string pipelineKey, string expectedKey)
    {
        ...
        Assert.Equal(expectedKey, Counter.LatestMetricValueUpdated?.Tags[ResilienceDimensions.PipelineKey]);
    }
    ...
    public void NotInitialized_DoesNotMeter(bool typed)
    {
        ...
        Assert.Null(Counter.LatestMetricValueUpdated);
    }
    ...
    public void NoOutgoingContext_ShouldNotThrow()
    {
        ...
        Assert.Equal(TelemetryConstants.Unknown, Counter.LatestMetricValueUpdated?.Tags[ResilienceDimensions.DependencyName]);
        Assert.Equal(TelemetryConstants.Unknown, Counter.LatestMetricValueUpdated?.Tags[ResilienceDimensions.RequestName]);
    }
    ...
    public void RecordEvent_NullException_Ok(bool typed)
    {
        ...
        var latest = Counter.LatestMetricValueUpdated!;
    ...
    public void RecordEvent_RequestMetadata(bool typed)
    {
        ...
        latest = Counter.LatestMetricValueUpdated!;
