...
public static class ResourceUtilizationHealthCheckExtensions
{
    ...
    /// <returns>The value of <paramref name="builder" />.</returns>
    /// <exception cref="T:System.ArgumentNullException">If <paramref name="builder" /> or <paramref name="section" /> are <see langword="null" />.</exception>
    ...
    /// <param name="tags">A list of tags that can be used to filter health checks.</param>
    /// <returns>The value of <paramref name="builder" />.</returns>
    /// <exception cref="T:System.ArgumentNullException">If <paramref name="builder" />, <paramref name="section" /> or <paramref name="tags" /> are <see langword="null" />.</exception>
    ...
    /// <returns>The value of <paramref name="builder" />.</returns>
    /// <exception cref="T:System.ArgumentNullException">If <paramref name="builder" /> or <paramref name="configure" /> are <see langword="null" />.</exception>
    ...
    /// <param name="tags">A list of tags that can be used to filter health checks.</param>
    /// <returns>The value of <paramref name="builder" />.</returns>
    /// <exception cref="T:System.ArgumentNullException">If <paramref name="builder" />, <paramref name="configure" /> or <paramref name="tags" /> are <see langword="null" />.</exception>
