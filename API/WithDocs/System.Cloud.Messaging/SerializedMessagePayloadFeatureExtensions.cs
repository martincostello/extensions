...
public static class SerializedMessagePayloadFeatureExtensions
{
    ...
    /// <exception cref="T:System.ArgumentNullException">If the <paramref name="context" /> is null.</exception>
    /// <exception cref="T:System.InvalidOperationException">If no <see cref="T:System.Cloud.Messaging.ISerializedMessagePayloadFeature`1" /> is set in the <paramref name="context" />.</exception>
