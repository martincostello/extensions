...
public static class MessageVisibilityDelayFeatureExtensions
{
    ...
    /// <summary>
    /// Try to get <see cref="T:System.Cloud.Messaging.IMessageVisibilityDelayFeature" /> in the provided <paramref name="visibilityDelay" /> from the <see cref="T:System.Cloud.Messaging.MessageContext" />.
    /// </summary>
    /// <param name="context">The message context.</param>
    ...
    /// <exception cref="T:System.ArgumentNullException">If <paramref name="context" /> is null.</exception>
    /// <exception cref="T:System.InvalidOperationException">If no source <see cref="T:Microsoft.AspNetCore.Http.Features.IFeatureCollection" /> is added to <paramref name="context" />.</exception>
