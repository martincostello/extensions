...
public interface ILogPropertyCollector
{
    ...
    /// <exception cref="T:System.ArgumentNullException">When <paramref name="propertyName" /> is <see langword="null" />.</exception>
    /// <exception cref="T:System.ArgumentException">When <paramref name="propertyName" /> is empty or contains exclusively whitespace,
