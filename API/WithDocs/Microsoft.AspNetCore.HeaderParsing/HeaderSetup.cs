...
public class HeaderSetup<THeader> where THeader : notnull
{
    ...
    /// </summary>
    /// <remarks>Not null when <see cref="P:Microsoft.AspNetCore.HeaderParsing.HeaderSetup`1.ParserInstance" /> is <see langword="null" /> and vice versa.</remarks>
    public Type? ParserType { get; }

    /// <summary>
    /// Gets the parser to parse header values.
    /// </summary>
    /// <remarks>Not null when <see cref="P:Microsoft.AspNetCore.HeaderParsing.HeaderSetup`1.ParserType" /> is <see langword="null" /> and vice versa.</remarks>
