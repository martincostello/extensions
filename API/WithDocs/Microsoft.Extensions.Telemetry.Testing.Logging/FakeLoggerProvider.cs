...
public class FakeLoggerProvider : ILoggerProvider, IDisposable, ISupportExternalScope
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Microsoft.Extensions.Telemetry.Testing.Logging.FakeLoggerProvider" /> class.
    /// </summary>
    ...
    /// <summary>
    /// Finalizes an instance of the <see cref="T:Microsoft.Extensions.Telemetry.Testing.Logging.FakeLoggerProvider" /> class.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new <see cref="T:Microsoft.Extensions.Telemetry.Testing.Logging.FakeLogger" /> instance.
    /// </summary>
    ...
    /// Clean up resources held by this object.
    /// </summary>
    /// <param name="disposing"><see lang="true" /> when called from the <see cref="M:Microsoft.Extensions.Telemetry.Testing.Logging.FakeLoggerProvider.Dispose" /> method, <see langword="false" /> when called from a finalizer.</param>
